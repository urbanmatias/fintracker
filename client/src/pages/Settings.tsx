...
export default function Settings() {
  ...
  // Calculate daily budget preview
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-surface rounded-xl p-6 border border-white/10 space-y-4">
          ...
          <div>
            <label htmlFor="income" className="block text-sm text-white/70 mb-1">Monto ($)</label>
            <input
              id="income"
              type="number"
              step="0.01"
        ...
        <div className="bg-surface rounded-xl p-6 border border-white/10 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="investment" className="block text-sm text-white/70 mb-1">
                A inversión (%)
              </label>
              <input
                id="investment"
            ...
            <div>
              <label htmlFor="savings" className="block text-sm text-white/70 mb-1">
                Queda en cuenta (%)
              </label>
              <input
                id="savings"
          ...
          <div>
            <label htmlFor="destination" className="block text-sm text-white/70 mb-1">
        ...
        <button
          type="submit"
          disabled={saving}
          className="px-6 py-2.5 bg-primary hover:bg-primary-dark rounded-lg font-medium transition-colors disabled:opacity-50"
        >
