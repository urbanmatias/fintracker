...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/15 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8 fade-in">
          ...
          <h1 className="text-2xl font-bold mb-1">
            Empezá con <span className="gradient-text">FinTracker</span>
          </h1>
          <p className="text-text-muted text-sm">Tomá el control de tus gastos diarios</p>
        </div>
        ...
        <div className="bg-surface/80 backdrop-blur rounded-2xl p-6 md:p-8 border border-border fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm text-text-muted mb-1.5">Nombre</label>
              <input
                id="name"
                type="text"
                value={name}
